...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Collage settings handlers
    if (collageLogoCorner) collageLogoCorner.addEventListener('change', updateAndSaveSettings);
    if (collageGap) collageGap.addEventListener('input', updateAndSaveSettings);
    if (collagePadding) collagePadding.addEventListener('input', updateAndSaveSettings);
...
function loadActiveSession() {
    ...
    designSettings.collage = { ...defaultSettings.collage, ...(designSettings.collage || {}) };
